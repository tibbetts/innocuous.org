---
title: "Toddler Science and Big Data"
date: 2011-01-03T01:16:00
slug: "toddler-science-and-big-data"
wp_id: 141
categories:
  - "Miscellaneous"
  - "Technology"
...
Of course, humans don’t make use of nearly all the data that is available to them. If they did, they would learn a whole lot more a whole lot more quickly, as we can learn from [Eliezer Yudkowsky’s fable That Alien Message](https://lesswrong.com/lw/qk/that_alien_message/). But we do receive a whole lot of data, and somehow filter through it to learn to interact with a complex universe, to empathize and communicate with other humans, to learn and to create new ideas. The amount of data consumed by a child before he learns to speak or throw a ball is staggering.

Computer Science is just starting to learn how to manage and analyze data sets at this scale. Today’s [Big Data](https://en.wikipedia.org/wiki/Big_data) systems come in many flavors, from Google and Facebook to Walmart and eBay. There is some debate about what big data means, with [Curt Monash](http://www.dbms2.com/2010/12/30/examples-and-definition-of-machine-generated-data/) and [Dan Abadi](https://dbmsmusings.blogspot.com/2010/12/machine-vs-human-generated-data.html) having recent posts on the topic.
